...
import domotica.view.HouseView;
...
public class TestCommand {
    ...
    public static void main(String[] args) {
        ...
        House house = new House("newHouse");


        DoorsClosedCommand setAllDoorsClosed = new DoorsClosedCommand(house.getBathroom(), house.getBedroom(), house.getKitchen(), house.getLiving());
        DoorsOpenCommand setAllDoorsOpen = new DoorsOpenCommand(house.getBathroom(), house.getBedroom(), house.getKitchen(), house.getLiving());

        remote.setCommand(setAllDoorsClosed);
        remote.buttonPressed();

        System.out.println("Status: " + house.getId() + "\nDOORS CLOSED:\nBathroom: " + house.getBathroom().isDoorClosed()
                            + "\nBedroom: " + house.getBedroom().isDoorClosed()
                            + "\nKitchen: " + house.getKitchen().isDoorClosed()
                            + "\nLiving: " + house.getLiving().isDoorClosed()+"\n");

        remote.setCommand(setAllDoorsOpen);
        remote.buttonPressed();
